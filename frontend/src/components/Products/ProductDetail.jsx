            ...
            {selectedProduct && (<div className='max-w-6xl mx-auto bg-white p-8 rounded-lg'>
                <div className='flex flex-col md:flex-row'>
                        ...
                        {selectedProduct.images.map((image, index) => (
                            <div key={index} className='flex flex-col items-center'>
                                <img
                                    ...
                                    className={`w-20 h-20 object-cover rounded-lg cursor-pointer border-2 ${mainImage === image.url ? "border-red-500" : "border-gray-300"}`}
                    ...
                    <div className='md:w-1/2'>
                        <div className='mb-4'>
                            <img src={selectedProduct.images[0]?.url} alt='Main' className='w-full h-auto object-cover rounded-lg' />
                        </div>
                    </div>
                    {/* mobile */}
